...
void GuiLayer::onAttach() {
	...
	const float editorIconSize = 32.0f;
	...
	float i = 1.0f;
	float j = 1.0f;
	editorIcons.registerIcon("Play", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Pause", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Stop", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Select", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Translate", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Rotate", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Scale", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Snap", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Local", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Build", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i = 1.0f;
	j++;
	editorIcons.registerIcon("Entity", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("System", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Component", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Rigidbody", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	editorIcons.registerIcon("Mesh", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(editorIconSize, editorIconSize));
	i++;
	...
	// register editor icons from font atlas
	const float fileIconSize = 64.0f;
	atlasSize = fileIcons.getAtlasSize();
	uvSize = ImVec2(((float)atlasSize.x / 10.0f) / atlasSize.x, ((float)atlasSize.y / 10.0f) / atlasSize.y);
	i = 1.0f;
	j = 1.0f;
	fileIcons.registerIcon("Folder", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("GenericFile", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("ColoredLogo", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("Logo", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("Material", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("C++", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
	fileIcons.registerIcon("C#", ImRect(uvSize.x * (i - 1), uvSize.y * (j - 1), uvSize.x * i, uvSize.y * j), ImVec2(fileIconSize, fileIconSize));
	i++;
